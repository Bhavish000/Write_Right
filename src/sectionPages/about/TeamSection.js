...
// Team Members
import teamimg1 from '@/styles/img/about/01.jpg';
import teamimg2 from '@/styles/img/about/02.jpg';
import teamimg3 from '@/styles/img/about/03.jpg';
import teamimg4 from '@/styles/img/about/04.png';
import teamimg5 from '@/styles/img/about/06.png';
import teamimg6 from '@/styles/img/about/07.png';
...
const Team = () => {
    ...
    return (
        <React.Fragment>
            <div id="rs-team" className="rs-team style1 inner-style orange-style pt-50 pb-100 md-pt-40 md-pb-70 back2-color" >
