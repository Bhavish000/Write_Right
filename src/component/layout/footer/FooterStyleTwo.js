                ...
                <div className={footerTopClass ? footerTopClass : "footer-top"}>
                    <div className="container">
                        ...
                        <div className="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                                ...
                                <ul className="site-map pl-0">
                                    <li><Link href="/about-abacus/what-is-abacus" className='white-color'>Handwriting Improvement</Link></li>
                                    <li><Link href="/#parent_faq" className='white-color'>Calligraphy</Link></li>
                                    <li><button href="#" className='white-color' onClick={() => openModal('TeacherIn')}>Speed Writing </button></li>
                            ...
                            <h4 className="widget-title">USEFUL LINK</h4>
                                <ul className="site-map pl-0">
                                    ...
                                    <li><Link href="/#parent_faq" className='white-color'>Download Parent Brochure</Link></li>
                                    
                                    <li><button href="#" className='white-color' onClick={() => openModal('offline')}>Student&apos;s login</button></li>
                                    <li><Link href="/#parent_testimonial" className='white-color'>Payment Options</Link></li>
                            ...
                            <h4 className="widget-title"></h4>
                                ...
                                <ul className="site-map mt-50 pl-0">
                                    <li><button href="#" className='white-color' onClick={() => openModal('bookclass')}>Inquiry for offline</button></li>
                                    {/* <li><button href="#" className='white-color' onClick={() => openModal('bookclass')}>Inquiry for Online</button></li> */}
                                    <li><button href="#" className='white-color' onClick={() => openModal('TeacherIn')}>Franchise Inquiry</button></li>
                                    <li><Link href="/abacus-worksheet-generator" className='white-color'> WorkSheet Generator</Link></li>
                            ...
                            <div className="col-lg-3 col-md-12 col-sm-12 footer-widget">
                                ...
                                <div className="address-widget address2">
                                    <ul className="footer-social d-flex justify-content-evenly pl-0" style={{ color: "#FD6C24", marginRight: '50px' }}>
                                        <li>
                                            <a href="https://www.facebook.com/writerightindiapage" target="_blank" aria-label="Go on facebook">
                                                <i className="fa fa-facebook-f" style={{ color: "gray" }}></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://x.com/writerightindia" target='_blank' aria-label="Go on twitter">
                                                <i className="fa fa-x-twitter" style={{ color: "gray" }}></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://www.instagram.com/writeright253/" target='_blank' aria-label="Go on instagram">
                                                <i className="fa fa-instagram" style={{ color: "gray" }}></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://www.youtube.com/mastermindwriteright" target='_blank' aria-label="Go on youtube">
                        ...
                        <div className="row y-middle">
                            <div className="col-lg-12 md-mb-20">
                                <div className="copyright text-center md-text-left">
                                    <p style={{ fontSize: "16px ", fontWeight: "600px" }}> Copyright © 2024 <strong>Mastermind Tutorials Pvt. Ltd.</strong> All rights reserved.</p>
                                </div>
                            </div>
