                   ...
                   <div className="col-md-6 text-center md-text-left " >
                    ...
                    <div className="col-md-5 text-right ml-10">
                        <ul className="topbar-right mb-0 pl-0">
                            <li className="login-register  mb-0"  >
