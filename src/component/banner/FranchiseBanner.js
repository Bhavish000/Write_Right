                    ...
                    <div className="row relative">
                        <div className="col-lg-6">
                            <div className="banner-content pb-14">
                                ...
                                <div className="banner-title family white-color" style={{ fontWeight: "800", textShadow:"0px 1px 1px black" }}>START YOUR OWN BUSINESS WITH A PROVEN HANDWRITING PROGRAM</div>

                                <div className="desc white-color mb-25" style={{ marginTop: "-10px"}}>Join Write Right, the pioneers in Handwriting Technology. Our research-backed, market-tested programs cover Handwriting Improvement, Speed Writing, Calligraphy, and Curriculum Books. Take the first step toward a successful education business by becoming a Write Right franchisee today.
                                ...
                                <div className="banner-btn z-index-1" >
                                    <div className="readon2 banner-style"   style={{cursor:'pointer', backgroundColor:"#fd6c24"}}>Apply Now</div>
                                </div>
                            </div>
