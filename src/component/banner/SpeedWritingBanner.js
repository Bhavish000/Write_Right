                            ...
                            <div className="col-xl-6 col-lg-6 col-md-9">
                                <div className="hero-content mt-10">
                                         <div className=" text-center">
											<div className="banner-top-heading" >Speed Writing
 
												</div>
										  <div className="banner-small-heading" > Double your writing speed with legibility.
                                          </div>
...
export default SpeedWritingBanner
