    ...
    <div>
       <div className="hero-area pos-rel">
            ...
            <div className="hero-slider">
                <div className="calligraphy slider-inner-height d-flex align-items-center" >
                    <div className="container">
                        <div className="row text-center">
                            <div className="col-xl-6 col-lg-6 col-md-9">
                                <div className="hero-content mt-10">
                                         <div className=" text-center">
											<div className="banner-top-heading" >Calligraphy Writing
 
												</div>
										  <div className="banner-small-heading" > Create Elegant & Artistically Stylized Calligraphy Letters.
                                          </div>
...
export default CalligraphyBanner
